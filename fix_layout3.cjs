...
content = content.replace(
  summaryMatch,
  `<div className={STYLES.card}><h3 className={STYLES.sectionTitle}>Summary</h3><div className="mb-6"><p className="text-sm text-gray-500">Review the finalized staff member's profile for deployment.</p></div>`
);
