...
- [ ] Trip duration bars need better styling
- [ ] Add grid lines for better readability
- [ ] Improve color contrast
- [ ] Add tooltips showing trip details on hover
...
- Add trip details on hover
- Improve driver name display
...
- [ ] Free up header space for better breathing room
- [ ] Improve header layout after removal
...
- [ ] Update area names (Al Barsha → Al Sadd, JBR → The Pearl, etc.)
- [ ] Update sample customer locations
