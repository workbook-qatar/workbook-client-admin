...
export default function QIDSearchStep({
  data,
  onUpdate,
  onNext,
  onBack,
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h2 className="text-xl font-semibold text-gray-900">
            QID Upload & Workbook ID Search
          </h2>
        </div>
        <p className="text-gray-600">
          Start by uploading the QID document and searching for existing
          Workbook ID
        </p>
      </div>
        ...
        {!uploadSuccess ? (
          ...
          <div className="border-2 border-green-500 bg-green-50 rounded-lg p-8 text-center">
            ...
            <p className="text-green-700 font-semibold text-lg mb-1">
              QID Uploaded / Verified Successfully
            </p>
