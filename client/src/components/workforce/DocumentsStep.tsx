...
export default function DocumentsStep({
  ...
  const handleDocumentChange = (
    ...
    if (docId === "dt1" || docId.includes("Passport")) {
      // Basic fuzzy matching for prototype
    ...
    <div className="bg-white rounded-lg border border-gray-200 p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Upload legal documents and banking information required by your
          organization.
        </p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center py-12 text-center bg-gray-50 border border-gray-100 rounded-xl border-dashed">
        ...
        <p className="text-gray-600 max-w-sm mt-2">
          Documents & Compliance requirements have been moved to the Staff
          Details page. You can add them after creating the profile.
        </p>
      </div>
