    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        {documentTypes.map(doc => (
          <div
            key={doc.id}
            className="border border-gray-100 bg-gray-50/50 rounded-xl p-5 hover:border-blue-100 transition-colors"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={e =>
                    handleDocumentChange(doc.id, "number", e.target.value)
                  }
              ...
              {doc.requiresExpiry && (
                <div>
                  ...
                  <Input
                    ...
                    onChange={e =>
                      handleDocumentChange(doc.id, "expiry", e.target.value)
                    }
                    className={`${UNIFORM_INPUT_CLASSES} mt-1.5`}
                  />
                </div>
