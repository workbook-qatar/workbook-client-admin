...
export default function StaffTypeStep({
  data,
  onUpdate,
  onNext,
  onBack,
    ...
    <div className="bg-white rounded-lg border border-gray-200 p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Choose the operational role for the new staff member.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        >
          <div className="flex flex-col items-center text-center">
            ...
            >
              <Users
                className={`h-8 w-8 ${data.staffType === "field-service" ? "text-blue-600" : "text-gray-600"}`}
              />
            </div>
            ...
            <div className="mt-auto pt-4 border-t border-gray-200/50 w-full text-center">
              ...
              <p className="text-xs text-gray-500 mt-2">
                Full workforce profile & operations features
              </p>
            </div>
          </div>
        </button>
        ...
        >
          <div className="flex flex-col items-center text-center">
            ...
            >
              <Truck
                className={`h-8 w-8 ${data.staffType === "driver" ? "text-orange-600" : "text-gray-600"}`}
              />
            </div>
            ...
            <div className="mt-auto pt-4 border-t border-gray-200/50 w-full text-center">
              ...
              <p className="text-xs text-gray-500 mt-2">
                Driver profile, trips & route workflow
              </p>
            </div>
          </div>
        </button>
        ...
        >
          <div className="flex flex-col items-center text-center">
            ...
            >
              <Building
                className={`h-8 w-8 ${data.staffType === "internal" ? "text-green-600" : "text-gray-600"}`}
              />
            </div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              Internal Staff
            ...
            <div className="mt-auto pt-4 border-t border-gray-200/50 w-full text-center">
              ...
              <p className="text-xs text-gray-500">
                Basic profile + dashboard permissions
              </p>
            </div>
          </div>
        </button>
        ...
        <div className="mb-8 p-6 bg-gray-50 rounded-xl border border-gray-100 animate-in fade-in slide-in-from-top-4 duration-500">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            <div className="flex-1">
              <p className="text-gray-700 font-medium mb-1">
                Does this member need dashboard access?
              </p>
              <p className="text-sm text-muted-foreground">
                Granting access will create a login account for them to access
                the admin portal.
              </p>
            </div>
            ...
            <div className="flex gap-4">
              ...
              >
                <div
                  className={`w-5 h-5 rounded-full border flex items-center justify-center ${data.systemAccess ? "border-green-600 bg-green-600" : "border-gray-400"}`}
                >
                  {data.systemAccess && (
              ...
              >
                <div
                  className={`w-5 h-5 rounded-full border flex items-center justify-center ${!data.systemAccess ? "border-gray-600 bg-gray-600" : "border-gray-400"}`}
                >
                  {!data.systemAccess && (
          ...
          {data.systemAccess && (
            <div className="mt-4 pt-4 border-t border-gray-200 text-sm text-green-700 flex items-center gap-2">
              <CheckCircle2 className="h-4 w-4" /> You will be asked to
              configure permissions in the next steps.
            </div>
          )}
          {!data.systemAccess && data.staffType === "internal" && (
            <div className="mt-4 pt-4 border-t border-gray-200 text-sm text-amber-600 flex items-center gap-2">
              <Users className="h-4 w-4" /> Internal staff usually require
              system access. Proceed only if this is for record-keeping.
            </div>
          )}
        </div>
      )}
