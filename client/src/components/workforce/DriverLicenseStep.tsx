    ...
    <div className="bg-white rounded-lg border border-gray-200 p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Start by uploading the Driving License for extraction or search
          existing ID
        </p>
      </div>
        ...
        {!uploadSuccess ? (
          ...
          <div className="border-2 border-green-500 bg-green-50 rounded-lg p-8 text-center">
            ...
            <p className="text-green-700 font-semibold text-lg mb-1">
              License Uploaded / Verified Successfully
            </p>
            ...
            <Button
              ...
              onClick={() => {
                ...
                onUpdate({ qidNumber: undefined, licenseNumber: undefined });
              }}
            >
              Reset
            </Button>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900">
                {data.licenseNumber || data.qidNumber}
              </p>
            </div>
            <div>
