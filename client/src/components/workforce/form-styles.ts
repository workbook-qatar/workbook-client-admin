export const UNIFORM_INPUT_CLASSES =
...
export const UNIFORM_SELECT_TRIGGER_CLASSES =
...
export const UNIFORM_SELECT_CONTENT_CLASSES =
  "border border-gray-200 rounded-lg shadow-lg bg-white";
export const UNIFORM_SELECT_ITEM_CLASSES =
  "px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer";
