  ...
  const steps = [
    {
      ...
      status: "completed",
      description:
        "Add your organization's address to Workbook to auto-populate them in invoices and bookings. Also, add users to provide access to your employees.",
      actions: [
    ...
    },
    {
      ...
      status: "current",
      description:
        "Add your drivers, technicians, and back-office staff. Define their roles, skills, and working hours to start assigning jobs efficiently.",
      actions: [
    ...
    },
    {
      ...
      status: "pending",
      description:
        "Define the services you offer, including pricing, duration, and required skills. This forms the backbone of your booking system.",
      actions: [
    ...
    },
    {
      ...
      status: "pending",
      description:
        "Set up automation rules for task assignment based on location, skills, and availability to optimize your operations.",
      actions: [
  ...
  const features = [
    {
      ...
      description:
        "Integrate with Stripe or PayPal to collect payments faster from your customers.",
    ...
    },
    {
      ...
      description:
        "Allow your customers to book services, track status, and view invoices online.",
    ...
    },
    {
      ...
      description:
        "Configure automated email and SMS reminders for bookings and staff updates.",
    ...
    },
    {
      ...
      description:
        "Secure your data by defining granular access controls for your team members.",
    ...
    <div className="space-y-10 max-w-6xl mx-auto pb-20">
      ...
      <div className="space-y-2">
        <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
          ...
          >
            <PlayCircle className="w-4 h-4" /> Overview of Workbook
          </a>
        </h1>
        <p className="text-gray-500">
          The complete operating system for your service business that you can
          set up in no time!
        </p>
      </div>
          ...
          <div className="md:col-span-4 border-r border-gray-100 bg-white py-4">
            {steps.map((step, index) => (
              ...
              >
                ...
                <div
                  className={`shrink-0 ${step.status === "completed" ? "text-green-500" : "text-gray-300"}`}
                >
                ...
                <span
                  className={`text-sm font-medium ${activeStep === index ? "text-blue-700" : "text-gray-600"}`}
                >
                  {step.title}
                </span>
              </button>
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                {steps[activeStep].actions.map((action, i) => (
                  <Button
                    key={i}
                    variant="link"
                    className="p-0 h-auto text-blue-600 font-semibold hover:no-underline hover:text-blue-700 flex items-center gap-1 group"
                  >
                    {action.label}{" "}
                    <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                    {i < steps[activeStep].actions.length - 1 && (
      ...
      <div className="space-y-6">
        <h3 className="text-lg font-bold text-gray-900">
          Explore useful features and set up Workbook
        </h3>
        <p className="text-gray-500 -mt-4">
          Your journey to effortlessly manage your operations starts here.
        </p>
            ...
            >
              <CardContent className="p-6 flex items-start gap-5">
                ...
                <div className="space-y-2">
                  ...
                  {feature.extra && (
                    <div className="text-xs font-semibold bg-gray-100 px-2 py-1 rounded w-fit text-gray-600 mt-2">
                      {feature.extra}
                    </div>
                  )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-500">
            Download the Workbook app for Android and iOS to manage your
      ...
      <div className="flex items-center justify-center pt-10 pb-4 text-gray-400 text-sm gap-2">
        <HelpCircle className="w-4 h-4" /> You can directly talk to us every
