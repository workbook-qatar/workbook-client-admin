    ...
    setTimeout(() => {
      try {
        ...
        const newStaff = {
          ...
          staffId:
            status === "active"
              ? `WB${Math.floor(Math.random() * 1000)
                  .toString()
                  .padStart(3, "0")}`
              : "",
          ...
          role: roleLabel,
          roleType:
            formData.staffType && roleTypeMap[formData.staffType]
              ? roleTypeMap[formData.staffType]
              : "part-time",
        ...
        if (existingIndex >= 0 && existingDriver) {
          ...
          staffList[existingIndex] = {
            ...
            staffId: existingDriver.staffId,
          }; // Keep ID
                ...
                {currentStep === 2 && (
                  <div className="bg-white p-6 rounded-lg border shadow-sm space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[10px] text-gray-400">
                          Will be used for login if access is granted.
                        </p>
                      </div>
                      <div className="space-y-1">
                        <Label className="text-xs font-semibold uppercase text-gray-500">
                        ...
                        <input
                          ...
                          value={formData.mobileNumber || "+974 "}
                          onChange={e =>
                    ...
                    <div className="flex justify-end pt-4">
                      <Button
                        onClick={handleNext}
                        disabled={!formData.fullName || !formData.emailAddress}
                      >
                        Continue
                      </Button>
                    </div>
                  ...
                  <div className="bg-white p-6 rounded-lg border shadow-sm space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                    ...
                    <div className="bg-gray-50 p-4 rounded-md border border-gray-100 flex items-center justify-between">
                      ...
                      <div className="flex bg-white rounded-lg border p-1">
                        <button
                          onClick={() => updateFormData({ systemAccess: true })}
                          className={`px-4 py-1.5 text-xs font-medium rounded ${formData.systemAccess ? "bg-purple-100 text-purple-700" : "text-gray-500 hover:bg-gray-50"}`}
                        >
                          Yes
                        </button>
                        <button
                          onClick={() =>
                            updateFormData({ systemAccess: false })
                          }
                          className={`px-4 py-1.5 text-xs font-medium rounded ${!formData.systemAccess ? "bg-gray-200 text-gray-800" : "text-gray-500 hover:bg-gray-50"}`}
                        >
                          No
                        </button>
                      </div>
                    ...
                    <div className="space-y-2 border-t pt-4">
                      ...
                      <textarea
                        ...
                        placeholder="Security notes, special instructions..."
                      />
                    </div>
                  ...
                  <div className="bg-white p-6 rounded-lg border shadow-sm space-y-4 text-center animate-in zoom-in-95 duration-300">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4 text-left max-w-md mx-auto space-y-3 text-sm mt-4 border border-gray-100">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span
                          className={`px-2 py-0.5 rounded text-xs font-bold ${formData.systemAccess ? "bg-purple-100 text-purple-700" : "bg-gray-200 text-gray-700"}`}
                        >
                    ...
                    <Button
                      className="w-full max-w-md mt-6 h-12 text-lg bg-purple-600 hover:bg-purple-700"
