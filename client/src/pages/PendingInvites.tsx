...
const STYLES = {
  ...
  badge: {
    ...
    accepted:
      "bg-green-100 text-green-700 hover:bg-green-100 border-0 shadow-none",
  },
};
...
export default function PendingInvites() {
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      const pending = allStaff.filter(s =>
        ["pending", "draft", "expired", "rejected", "accepted"].includes(
          s.membershipStatus || ""
        )
      );
  ...
  const filteredInvites = invites.filter(s => {
    ...
    const matchesStatus = selectedStatus
      ? s.membershipStatus?.toLowerCase() === selectedStatus.toLowerCase()
      : true;
        ...
        <div className="px-8 py-6 border-b bg-white flex items-center justify-between sticky top-0 z-10">
          <div className="flex items-center gap-4">
            <Button
              variant="ghost"
              size="icon"
              className="hover:bg-gray-100 rounded-lg h-9 w-9 text-gray-500"
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm mt-1">
                Track and manage sent invitations grouped by roles
              </p>
            </div>
          </div>
          <div className="flex gap-3">
            <Button
              size="sm"
              onClick={() => setLocation("/workforce?invite=true")}
              className="bg-blue-600 hover:bg-blue-700 text-white gap-2 shadow-lg shadow-blue-600/20 px-4 h-10"
            >
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="outline"
                      size="sm"
                      className="h-10 px-4 gap-2 bg-white border-gray-200 shadow-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50"
                    >
                  ...
                  <DropdownMenuContent
                    align="end"
                    className="w-[200px] bg-white border border-gray-200 shadow-lg rounded-xl overflow-hidden p-1"
                  >
                    <DropdownMenuItem
            ...
            <div className="flex-1 min-h-0 flex gap-6">
              ...
              >
                <div className="p-4 border-b flex items-center justify-between bg-gray-50/80 backdrop-blur-sm">
                  <h3 className="font-bold text-sm text-gray-900 tracking-wide uppercase text-xs">
                    Role Selection
                  </h3>
                </div>
                  ...
                  <Table>
                    <TableHeader className="bg-gray-50/90 backdrop-blur-sm sticky top-0 z-10 border-b border-gray-200">
                      <TableRow className="hover:bg-transparent">
                        <TableHead className="w-[300px] text-xs font-semibold uppercase tracking-wider text-gray-500 py-4 px-5">
                          Name
                        </TableHead>
                    ...
                    <TableBody>
                      {isTableLoading ? (
                        ...
                        <TableRow>
                          <TableCell
                            colSpan={6}
                            className="h-48 text-center text-muted-foreground bg-white"
                          >
                            <div className="flex flex-col items-center gap-3">
                              ...
                              <p className="text-sm text-gray-500">
                                No pending invites found in this category.
                              </p>
                            </div>
                          </TableCell>
                        </TableRow>
                        ...
                        paginatedInvites.map(staff => (
                          <TableRow
                            ...
                            onClick={() =>
                              setLocation(`/workforce/pending/${staff.id}`)
                            }
                          >
                            <TableCell className="px-5 py-3.5">
                              <div className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col py-0.5">
                                  <span className="font-semibold text-sm text-gray-900 leading-tight truncate max-w-[200px]">
                                    {staff.name}
                                  </span>
