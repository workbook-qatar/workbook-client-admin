...
const OrganizationCard = ({
  ...
  return (
    <div
      className={`relative flex items-center justify-between p-6 bg-white rounded-lg border transition-all duration-200 ${isActive ? "border-blue-100 shadow-sm ring-1 ring-blue-50" : "border-gray-200 hover:border-gray-300 hover:shadow-sm"}`}
    >
      {org.isDefault && (
      ...
      <div className="flex items-start gap-6">
        ...
        <div className="flex flex-col gap-1 w-full max-w-2xl">
          ...
          <p className="text-sm text-gray-500 mt-3 font-normal">
            You are an{" "}
            <span className="font-bold text-gray-900">{org.role}</span> in this
            organization
          </p>
        </div>
      </div>
...
export default function OrganizationHub() {
  ...
  const handleLeaveRequest = (org: Organization) => {
    ...
    if (org.role === "admin") {
      setAlertMessage({
        ...
        message:
          "You can make another user an Admin and leave, or delete the organization.",
      });
  ...
  const filteredOrgs = availableOrganizations.filter(
    org =>
  ...
  return (
    <div className="min-h-screen bg-muted/20 p-8">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        {alertMessage && (
          <div
            className={`p-4 rounded-md border flex items-start gap-3 relative ${
          ...
          >
            ...
            <div className="pr-8">
              <p className="font-medium text-sm">{alertMessage.title}</p>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pt-2">
          <div>
            <Button
              variant="ghost"
              className="mb-2 pl-0 hover:bg-transparent text-muted-foreground transition-colors hover:text-foreground"
      ...
      <AlertDialog
        open={!!orgToAction && dialogType === "leave"}
        onOpenChange={open => !open && setOrgToAction(null)}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <strong>{orgToAction?.name}</strong>?
              <br />
              <br />
              You will lose access to all resources, projects, and member data
              within this organization immediately. You will need to be
      ...
      <Dialog
        open={!!orgToAction && dialogType === "delete"}
        onOpenChange={open => !open && setOrgToAction(null)}
      >
        <DialogContent className="max-w-xl p-0 gap-0 overflow-hidden">
          ...
          <div className="px-6 py-4 space-y-5">
            <p className="text-gray-600 text-sm">
              ...
              <strong>{orgToAction?.name}</strong> permanently. If you want to
              keep a backup of your data, take a backup before you proceed.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex gap-3 text-xs text-gray-600 bg-gray-50 p-3 rounded-md border-l-4 border-red-500">
                ...
                <p>
                  Sometimes, the local law might require you to keep a record of
                  your data for a certain period of time. In such cases, you
                  would need to maintain a backup of your data.
                </p>
              </div>
              ...
              <div className="flex gap-3 text-xs text-gray-600 bg-gray-50 p-3 rounded-md border-l-4 border-orange-400">
                ...
                <p>
                  All active projects, employee records, invoices, and
                  communication history will be permanently erased and cannot be
                  recovered.
                </p>
              </div>
            </div>
            ...
            <div className="bg-sky-50 border border-sky-100 rounded-md p-3 flex gap-3">
              ...
              <div className="text-xs text-sky-900 leading-relaxed">
                <p className="font-semibold inline">
                  To backup data for the selected organization:
                </p>
                <span>
                  {" "}
                  Go to your Organization &gt; Settings &gt; Data Backup &gt;
                  Backup Your Data.{" "}
                </span>
                <a
                  href="#"
                  ...
                  onClick={e => {
                    e.preventDefault();
                    setLocation("/settings/data-backup");
                  }}
                >
                  Learn More
                </a>
            ...
            <div
              ...
              onClick={() =>
                setDeleteConfirmation(
                  deleteConfirmation === "checked" ? "" : "checked"
                )
              }
            >
              <div
                className={`h-4 w-4 rounded border flex items-center justify-center transition-colors ${deleteConfirmation === "checked" ? "bg-red-600 border-red-600" : "border-gray-400 bg-white"}`}
              >
                {deleteConfirmation === "checked" && (
