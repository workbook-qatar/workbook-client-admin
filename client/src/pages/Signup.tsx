...
export default function Signup() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (
      formData.email.toLowerCase() === "demo@workbook.com" ||
      formData.email.toLowerCase() === "test@example.com"
    ) {
      newErrors.email =
      ...
      <div className="hidden lg:flex w-5/12 bg-neutral-900 relative flex-col text-white p-12 justify-between">
        <div className="z-10">
          ...
          <p className="text-neutral-400 text-lg mb-10 leading-relaxed font-light">
            Join thousands of forward-thinking businesses who trust Workbook to
            streamline their operations, finance, and workforce.
          </p>
        ...
        <div className="z-10">
          <div className="bg-white/5 rounded-xl p-6 backdrop-blur-sm border border-white/10">
            ...
            <p className="italic text-neutral-300 mb-4 font-light">
              "Workbook transformed how we handle our daily dispatching. It's
              simply the best tool we've used in years."
            </p>
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 bg-neutral-700/50 rounded-full flex items-center justify-center font-bold text-sm">
                JD
              </div>
              <div>
