...
export default function CreateOrganization() {
  ...
  const [step, setStep] = useState<"welcome" | "details" | "success">(
    "welcome"
  );
      ...
      <div className="min-h-screen bg-white flex flex-col pt-20 items-center">
        ...
        <div className="mb-12 flex items-center gap-2">
          ...
          <span className="text-gray-500 text-sm">
            Workbook is your end-to-end business software.
          </span>
        </div>
        ...
        <div className="w-full max-w-2xl px-6">
          ...
          <p className="text-gray-500 mb-8">
            Let us know where your business is & we'll optimize Workbook
            accordingly!
          </p>
          ...
          <div className="w-64 bg-[#1e293b] h-full flex flex-col p-4 gap-4">
            ...
            <div className="space-y-2">
              {[1, 2, 3, 4, 5].map(i => (
                <div
                  key={i}
                  className="h-2 w-3/4 bg-slate-700/50 rounded"
                ></div>
              ))}
            </div>
          </div>
          ...
          <Card className="w-full max-w-lg border-none shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] bg-white relative overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <CardContent className="pt-12 pb-12 px-10 text-center relative z-10">
              ...
              <p className="text-gray-500 mb-8 text-sm leading-relaxed max-w-sm mx-auto">
                Thank you for choosing Workbook. Before you start, we'd love to
                show you around and help you navigate the app.
              </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-8 px-4 sm:px-8">
                ...
                <div className="space-y-1">
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        variant="outline"
                        className={`${UNIFORM_INPUT_CLASSES} flex justify-between items-center font-normal px-3`}
                        type="button"
                      >
                        <span
                          className={
                    ...
                    <DropdownMenuContent
                      className="w-[var(--radix-dropdown-menu-trigger-width)] max-h-[300px] overflow-y-auto bg-white"
                      align="start"
                    >
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="Asia/Qatar">
                        (GMT+03:00) Qatar Standard Time
                      </SelectItem>
                      <SelectItem value="Asia/Dubai">
                        (GMT+04:00) Gulf Standard Time
                      </SelectItem>
                      <SelectItem value="Asia/Riyadh">
                        (GMT+03:00) Saudi Standard Time
                      </SelectItem>
                    </SelectContent>
                  </Select>
                </div>
            ...
            <div className="border-t border-gray-100 pt-6 space-y-3">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm text-gray-500">
                <li>
                  You can update your organization profile and preferences from
                  Settings anytime.
                </li>
              </ul>
            </div>
