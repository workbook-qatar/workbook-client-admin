...
const DEFAULT_DOCUMENTS: DocumentType[] = [
  ...
  },
  {
    id: "dt2",
    name: "Visa / QID",
    description: "Residency or work permit",
    requiresExpiry: true,
    status: "active",
  },
  {
  ...
  },
  {
    ...
    description: "Medical fitness record",
    requiresExpiry: true,
    status: "active",
  },
  {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Manage required staff documents and expiry rules.
              </p>
            </div>
          </div>
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={checked =>
                      setFormData({
                        ...formData,
                        requiresExpiry: checked as boolean,
                      })
                    }
                  />
                  <Label
        ...
        <div className="p-8 max-w-4xl mx-auto w-full">
          ...
          <div className="grid gap-3">
            {filteredList.map(item => (
              <Card
                key={item.id}
                className="p-4 flex items-center justify-between hover:border-rose-300 transition-all group bg-white border-gray-200/60"
              >
                <div className="flex items-center gap-4">
