  ...
  const handleSave = () => {
    ...
    if (editingId) {
      newSkills = newSkills.map(s =>
        s.id === editingId ? ({ ...s, ...formData } as Skill) : s
      );
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Define capabilities and certification requirements for your
                workforce.
              </p>
            </div>
          </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={checked =>
                        setFormData({ ...formData, requiresCert: checked })
                      }
                    />
                  </div>
                  ...
                  {formData.requiresCert && (
                    <div className="space-y-4 animate-in fade-in slide-in-from-top-2 bg-orange-50/50 p-4 rounded-lg border border-orange-100">
                      <div className="space-y-2">
                        <Label htmlFor="certName" className="text-orange-900">
                          Certificate Name{" "}
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={checked =>
                            setFormData({ ...formData, certExpiry: checked })
                          }
                        />
                      </div>
                    </div>
        ...
        <div className="p-8 max-w-5xl mx-auto w-full">
          ...
          <div className="grid gap-3">
            {filteredSkills.map(skill => (
              <Card
                key={skill.id}
                className="p-4 flex items-center justify-between hover:border-cyan-300 transition-all group bg-white border-gray-200/60"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 text-sm flex items-center gap-2">
                      ...
                      {skill.requiresCert && (
                        <Badge
                          variant="outline"
                          className="text-[10px] h-5 px-1.5 py-0 border-orange-200 text-orange-700 bg-orange-50 gap-1"
                        >
                    ...
                    {skill.requiresCert && skill.certName ? (
                      <p className="text-xs text-gray-500 mt-0.5 flex items-center gap-1.5">
                        ...
                        {skill.certExpiry && (
                          <span
                            className="text-gray-400 flex items-center gap-1 ml-1"
