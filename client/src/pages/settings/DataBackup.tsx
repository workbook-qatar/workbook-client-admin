      ...
      <div className="p-6 max-w-4xl mx-auto space-y-8">
        ...
        <Card className="border-blue-100 shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Securely export all your organization's data including projects,
            ...
            <div className="bg-blue-50/50 p-4 rounded-lg flex items-start gap-3 border border-blue-100">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-blue-700 leading-relaxed">
                  Regular backups ensure compliance with local data retention
                  laws (e.g., Qatar Financial Regulations) and provide a safety
                  net before making critical changes.
                </p>
              </div>
            </div>
        ...
        <DialogContent className="max-w-xl p-0 overflow-hidden">
          ...
          <div className="px-6 py-4 space-y-5">
            <p className="text-gray-600">
              ...
              <strong>{orgName}</strong> permanently. If you want to keep a
              backup of your data, take a backup before you proceed.
            </p>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3 text-sm text-gray-600 bg-gray-50 p-3 rounded-md border-l-4 border-orange-400">
                ...
                <p>
                  All active projects, employee records, and communication
                  history will be permanently erased and cannot be recovered.
                </p>
              </div>
            </div>
              ...
              <div className="text-sm text-sky-900">
                ...
                <p className="mt-1">
                  ...
                  <span className="font-semibold">
                    Settings &gt; Data Backup &gt; Backup Your Data
                  </span>
                  .
                </p>
              </div>
