...
const DEFAULT_DEPARTMENTS: OrganizationItem[] = [
  ...
  },
  {
    id: "d2",
    name: "Sales",
    description: "Customer acquisition and relations",
    status: "active",
  ...
  },
  {
    id: "d3",
    name: "Technical",
    description: "Specialized technical support",
    status: "active",
    applicableTo: ["internal", "field_service"],
  },
  {
    id: "d4",
    name: "Administration",
    description: "Internal office management",
    status: "active",
    applicableTo: ["internal"],
  },
  {
...
const DEFAULT_TEAMS: OrganizationItem[] = [
  {
    id: "t1",
    name: "Alpha Squad",
    description: "Morning shift field team",
    status: "active",
  ...
  },
  {
    id: "t2",
    name: "Beta Squad",
    description: "Evening shift field team",
    status: "active",
    applicableTo: ["field_service"],
  },
  {
    ...
    status: "active",
    applicableTo: ["field_service", "driver"],
  },
];
...
const DEFAULT_JOB_TITLES: OrganizationItem[] = [
  {
    id: "j1",
    name: "Cleaner",
    description: "General cleaning staff",
    status: "active",
    applicableTo: ["field_service"],
  },
  {
  ...
  },
  {
    ...
    status: "active",
    applicableTo: ["field_service", "internal"],
  },
];
...
export default function OrganizationStructure() {
  ...
  useEffect(() => {
    ...
    if (storedJobs) setJobTitles(JSON.parse(storedJobs));
      ...
      localStorage.setItem(
        "vendor_job_titles",
        JSON.stringify(DEFAULT_JOB_TITLES)
      );
    }
  }, []);
                  ...
                  <DialogContent>
                    ...
                    <div className="space-y-4 py-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          id="name"
                          placeholder={`e.g. ${activeTab === "departments" ? "Marketing" : activeTab === "teams" ? "Alpha Squad" : "Senior Technician"}`}
                          value={formData.name}
                          onChange={e =>
                        ...
                        <div className="flex flex-col gap-2 p-3 border rounded-md bg-gray-50/50">
                          {MEMBER_TYPES.map(type => {
                            ...
                            return (
                              ...
                              >
                                <div
                                  className={`h-4 w-4 rounded border flex items-center justify-center transition-colors ${isChecked ? "bg-blue-600 border-blue-600" : "bg-white border-gray-300"}`}
                                >
                                  {isChecked && (
                                    <div
                                      className="h-1.5 w-2 bg-white -rotate-45 border-l-2 border-b-2 border-white transform mb-0.5"
                                      style={{
                                        width: 6,
                                        height: 4,
                                        borderRadius: 1,
            ...
            <TabsContent value="departments" className="mt-0">
              <div className="grid gap-3">
                {filteredList.map(item => (
                  <Card
                    key={item.id}
                    className="p-4 flex items-center justify-between hover:border-blue-300 transition-all group bg-white"
                  >
                    <div className="flex items-center gap-4">
