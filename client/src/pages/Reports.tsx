    ...
    <DashboardLayout>
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card
            className="glass-panel cursor-pointer hover:bg-card/90 transition-all border-blue-100 group"
          ...
          >
            ...
            <CardContent>
              ...
              <Button
                variant="outline"
                className="w-full bg-white/50 border-blue-200 hover:bg-blue-50"
                onClick={handleFeatureClick}
              >
          ...
          <Card
            className="glass-panel cursor-pointer hover:bg-card/90 transition-all border-green-100 group"
            onClick={handleFeatureClick}
          >
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-lg">
            ...
            <CardContent>
              ...
              <Button
                variant="outline"
                className="w-full bg-white/50 border-green-200 hover:bg-green-50"
                onClick={handleFeatureClick}
              >
                <Download className="h-4 w-4 mr-2" />
                Generate Report
          ...
          <Card
            className="glass-panel cursor-pointer hover:bg-card/90 transition-all border-purple-100 group"
            onClick={handleFeatureClick}
          >
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-lg">
