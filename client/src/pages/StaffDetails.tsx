    ...
    <div className="flex items-center justify-between">
      ...
      {!isEditing && staff.membershipStatus === "active" && (
        <Button
          ...
          className="h-8 w-8 p-0 rounded-full hover:bg-gray-100 text-gray-400 hover:text-primary"
        >
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-1">
            ...
            {isEditing ? (
              ...
              <div className="font-medium">{staff.nickname || "-"}</div>
            )}
          </div>
          ...
          {staff.roleType !== "Internal Staff" && (
            <>
              <div className="space-y-1">
                ...
                <div className="font-medium">{staff.qid}</div>
              </div>
              <div className="space-y-1">
                <Label className="text-xs text-muted-foreground uppercase">
                  Nationality
          ...
          <div className="space-y-1">
            ...
            <div className="font-medium">{staff.department || "General"}</div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <Badge
              variant={
                staff.employmentStatus === "Active" ? "default" : "secondary"
              }
              className={
          ...
          <div className="space-y-1">
            ...
            <div className="font-medium">{staff.joiningDate || "Not set"}</div>
          </div>
        </CardContent>
      </Card>
      ...
      {(staff.position === "Driver" || staff.roleType === "driver") && (
        <Card className="md:col-span-3 border-orange-200 bg-orange-50/30">
          <CardHeader>
            <SectionHeader icon={TrendingUp} title="Operations & Vehicle" />
          </CardHeader>
          <CardContent className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="space-y-1">
              ...
              <div className="font-medium">Light Vehicle</div>
            </div>
            <div className="space-y-1">
              <Label className="text-xs text-muted-foreground uppercase">
                License Number
              </Label>
              <div className="font-medium">DL-99887766</div>
            </div>
            <div className="space-y-1">
              <Label className="text-xs text-muted-foreground uppercase">
                Expiry
              </Label>
              <div className="font-medium text-amber-700">2026-05-15</div>
            </div>
          </CardContent>
        </Card>
      )}
      ...
      <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
              ...
              <div className="relative group shrink-0">
                <Avatar className="h-24 w-24 border-4 border-white shadow-lg rounded-2xl">
                  <AvatarImage
                    src={isEditing ? formData.avatar : staff.avatar}
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 text-sm text-muted-foreground">
                      ...
                      {staff.membershipStatus !== "active" && (
                        <Badge
                          variant="outline"
                          className="text-amber-600 border-amber-200 bg-amber-50 capitalize"
                        >
                          {staff.membershipStatus}
                        </Badge>
                      )}
                    </div>
                  </div>
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <div
                            className={`flex items-center gap-2 px-3 py-1.5 rounded-md border ${getWorkStatusColor(workStatusData.status)}`}
                          >
                            <div
                              className={`h-2 w-2 rounded-full ${workStatusData.status === "Available" ? "bg-green-500" : workStatusData.status === "Offline" ? "bg-gray-400" : "bg-blue-500"}`}
                            />
                        ...
                        <TooltipContent>
                          ...
                          <p className="text-xs text-muted-foreground">
                            Based on active jobs and employment status.
                          </p>
                          {workStatusData.context && (
                    ...
                    <div className="flex items-center gap-2">
                      {!isEditing && (
                        <Select
                          ...
                          onValueChange={val =>
                            initiateStatusChange(val as EmploymentStatus)
                          }
                        >
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                          ...
                          onClick={() => initiateStatusChange("Inactive")}
                        >
                          <AlertTriangle className="h-4 w-4 mr-2" /> Deactivate
                          Staff
                        </DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <Card
              key={i}
              className="shadow-sm border-gray-100 bg-white/60 hover:bg-white transition-colors"
            >
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <>
                <>
                  ...
                  {(staff.position === "Driver" ||
                    staff.roleType === "driver") && (
                    <TabsTrigger value="trips">Trips & Route</TabsTrigger>
                  )}
            ...
            <Card>
              <CardHeader className="py-4">
                <CardTitle className="text-base font-semibold flex items-center gap-2">
                  <CalendarCheck className="h-4 w-4 text-blue-500" /> Upcoming
                  Schedule
                </CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent
            value="trips"
            className="mt-6 animate-in fade-in slide-in-from-bottom-2"
          >
              ...
              <Card className="border-blue-200 bg-blue-50/50">
                <CardHeader className="py-3 items-start">
                  <CardTitle className="text-sm text-blue-700 flex items-center gap-2">
                    <MapPin className="h-4 w-4" /> Current Trip
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <h3 className="font-bold text-lg">TR-2938</h3>
                  <div className="text-sm text-gray-600 mt-1">
                    To: Pearl Qatar, Tower 4
                  </div>
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell>
                        Warehouse &rarr; West Bay (Delivery)
                      </TableCell>
          ...
          <TabsContent value="availability" className="mt-6">
            <div className="p-10 text-center text-muted-foreground bg-gray-50 rounded-lg border border-dashed">
              Availability Component Ready
            </div>
          </TabsContent>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  <SectionHeader icon={ShieldCheck} title="Assigned Role" />
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <ul className="space-y-1 text-sm">
                      ...
                      <li className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-green-500" /> View
                        Financials
                      </li>
                      <li className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-green-500" /> Edit
                        System Settings
                      </li>
                    </ul>
                  </div>
              ...
              <Card>
                <CardHeader>
                  <SectionHeader icon={Lock} title="Access Settings" />
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        User can log in to admin panel
                      </div>
                    </div>
                    <Switch checked={true} />
                  </div>
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell>
                        Successful login from IP 192.168.1.1
                      </TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="text-gray-500">
          ...
          >
            <Card className="border-red-100">
              <CardHeader>
                <SectionHeader icon={ShieldCheck} title="Security Actions" />
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 border rounded bg-red-50 border-red-100">
                  <div>
                    ...
                    <div className="text-sm text-red-600">
                      Force logout and prevent new logins
                    </div>
                  </div>
      ...
      <Dialog open={statusDialogOpen} onOpenChange={setStatusDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              You are checking the staff status to{" "}
