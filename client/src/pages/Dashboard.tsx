        ...
        >
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              <div>
                ...
                <p className="text-blue-100 text-lg max-w-xl">
                  Here's what's happening in your operations today. You have{" "}
                  <span className="font-bold text-white">45 bookings</span>{" "}
                  scheduled.
                </p>
          ...
          <div className="grid grid-cols-5 gap-4">
            ...
            >
              <CardContent className="pt-6">
                <div className="flex flex-col">
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-sm font-medium text-red-600/80 group-hover:text-red-600 transition-colors">
                      Unassigned
                    </p>
            ...
            >
              <CardContent className="pt-6">
                <div className="flex flex-col">
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-sm font-medium text-muted-foreground group-hover:text-gray-600 transition-colors">
                      Cancelled
                    </p>
          ...
          >
            <div className="flex items-center gap-4">
              <div
                className={`p-3 rounded-full ${capacityIndicator.canAcceptMore ? "bg-green-100 text-green-600" : "bg-red-100 text-red-600"}`}
              >
                {capacityIndicator.canAcceptMore ? (
              ...
              <div>
                ...
                <p className="text-sm text-gray-600/80 font-medium mt-1">
                  Currently running at {capacityIndicator.utilizationPercentage}
                  % efficiency
                </p>
              </div>
            </div>
            <div className="flex items-center gap-4 min-w-[300px]">
              <div className="flex-1 h-3 bg-white/50 rounded-full overflow-hidden backdrop-blur-sm border border-black/5">
                <div
                  ...
                  style={{
                    width: `${capacityIndicator.utilizationPercentage}%`,
                  }}
                />
              </div>
          ...
          <Tabs defaultValue="overview" className="w-full">
                          ...
                          <div className="p-4 bg-red-50/50 border border-red-100 rounded-xl flex items-center justify-between group hover:bg-red-50 transition-colors">
                            <div>
                              ...
                              <p className="text-sm text-red-700/80 mt-1">
                                These jobs need immediate assignment
                              </p>
                            </div>
                            <Button
                              size="sm"
                          ...
                          >
                            <div className="flex items-start justify-between">
                              ...
                              <Button
                                size="icon"
                                variant="ghost"
                                className="rounded-full hover:bg-gray-100 text-gray-400 hover:text-primary"
                              >
                    ...
                    <CardContent className="pt-6">
                      <div className="space-y-6">
                        <div className="grid grid-cols-3 gap-4">
                          ...
                          >
                            <p className="text-3xl font-heading font-bold text-green-700 group-hover:scale-110 transition-transform">
                              {staffSummary.available}
                            </p>
                          ...
                          >
                            <p className="text-3xl font-heading font-bold text-blue-700 group-hover:scale-110 transition-transform">
                              {staffSummary.busy}
                            </p>
                          ...
                          >
                            <p className="text-3xl font-heading font-bold text-red-700 group-hover:scale-110 transition-transform">
                              {staffSummary.absent}
                            </p>
                        ...
                        <div className="p-5 bg-muted/30 rounded-2xl border border-border/50">
                          ...
                          <div className="-mt-4 -mb-2">
                            <UtilizationRadialChart
                              value={staffSummary.utilizationPercentage}
                            />
                          </div>

                          <p className="text-xs text-center text-muted-foreground font-medium pb-2">
                            {staffSummary.onDuty} of {staffSummary.total} staff
                            currently active
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-6">
                        <div className="text-center py-4 bg-white/60 rounded-2xl border border-blue-100 shadow-sm backdrop-blur-sm">
                          ...
                          <p className="text-5xl font-heading font-bold text-blue-900 tracking-tight">
                            <span className="text-2xl align-top mr-1 opacity-50">
                              QAR
                            </span>
                  ...
                  <Card className="glass-panel overflow-hidden border-indigo-200/50 hover:shadow-indigo-500/10 hover:shadow-lg transition-all">
                    ...
                    <CardHeader className="bg-indigo-50/50 border-b border-indigo-100/50 relative z-10">
                      <CardTitle className="flex items-center gap-2 text-indigo-900">
                        ...
                        <Badge
                          variant="secondary"
                          className="bg-indigo-100 text-indigo-700 hover:bg-indigo-200 ml-2"
                        >
                          Next 2 Hours
                        </Badge>
                      </CardTitle>
                    ...
                    <CardContent className="pt-6 relative z-10">
                      <div className="space-y-4">
                        {next2HoursRisks.map(risk => (
                          ...
                          >
                            <div className="flex items-center justify-between mb-2">
                              <span className="text-sm font-bold bg-white/80 px-2 py-0.5 rounded text-gray-800">
                                {risk.time}
                              </span>
                              <Badge
                                className={
                      ...
                      <div className="space-y-3">
                        {unassignedBookings.map(booking => (
                          <div
                            ...
                            onClick={() =>
                              navigateToBookings(`booking ${booking.id}`)
                            }
                          >
                      ...
                      <div className="space-y-3">
                        {staffIssues.map(issue => (
                          <div
                            ...
                            onClick={() =>
                              navigateToWorkforce(`staff ${issue.staffName}`)
                            }
                          >
                            <div className="flex items-center justify-between">
                              <div>
                      ...
                      <div className="space-y-3">
                        {paymentFailures.map(payment => (
                          <div
                            ...
                            className="p-4 bg-white rounded-lg border border-red-200 cursor-pointer hover:shadow-md transition-all"
                            onClick={() =>
                              navigateToBookings(`booking ${payment.bookingId}`)
                            }
                          >
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="text-sm text-gray-600 mt-1">
                                  Amount: QAR {payment.amount} • Reason:{" "}
                                  {payment.reason}
                                </p>
                      ...
                      <div className="space-y-3">
                        {customerComplaints.map(complaint => (
                          <div
                            ...
                            onClick={() =>
                              navigateToBookings("customer complaint")
                            }
                          >
                            <div className="flex items-center justify-between">
                              <div>
            ...
            <TabsContent value="staff" className="space-y-6 mt-6">
              ...
              <div className="grid grid-cols-4 gap-6">
                ...
                <Card
                  className="cursor-pointer hover:shadow-lg transition-all"
                  onClick={() => navigateToWorkforce("on duty")}
                >
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                      ...
                      <div className="space-y-3">
                        {availableStaff.map(staff => (
                          <div
                            ...
                            onClick={() =>
                              navigateToWorkforce(`staff ${staff.name}`)
                            }
                          >
                            <div className="flex items-center justify-between">
                              <div>
                              ...
                              <div className="flex-1">
                                ...
                                <div className="grid grid-cols-2 gap-2 mt-2 text-sm">
                                  <div>
                                    ...
                                    <p className="font-semibold text-gray-900">
                                      {staff.completedToday} jobs
                                    </p>
                                  </div>
                                  <div>
                                    <p className="text-gray-500">Revenue</p>
                                    <p className="font-semibold text-gray-900">
                                      QAR {staff.revenueToday}
                                    </p>
                                  </div>
                                  <div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-3xl font-bold text-gray-900 mt-2">
                          QAR {revenueOverview.today.toLocaleString()}
                        </p>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-3xl font-bold text-gray-900 mt-2">
                          QAR {revenueOverview.thisWeek.toLocaleString()}
                        </p>
                        <p className="text-sm text-green-600 flex items-center gap-1 mt-1">
                          <TrendingUp className="h-3 w-3" />+
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-3xl font-bold text-gray-900 mt-2">
                          QAR {revenueOverview.thisMonth.toLocaleString()}
                        </p>
                        <p className="text-sm text-green-600 flex items-center gap-1 mt-1">
                          <TrendingUp className="h-3 w-3" />+
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-3xl font-bold text-gray-900 mt-2">
                          QAR {revenueOverview.averagePerBooking}
                        </p>
                      ...
                      <div className="space-y-4">
                        {revenueBySource.map(source => (
                          <div
                            ...
                            onClick={() =>
                              navigateToBookings(`source: ${source.source}`)
                            }
                          >
                            <div className="flex items-center justify-between mb-2">
                              <p className="font-semibold text-gray-900">
                            ...
                            <div className="flex items-center justify-between">
                              <div>
                                <p className="text-2xl font-bold text-gray-900">
                                  QAR {source.revenue.toLocaleString()}
                                </p>
                                <p className="text-sm text-gray-600 mt-1">
                    ...
                    <CardHeader>
                      <CardTitle className="flex items-center justify-between">
                        ...
                        <Button
                          ...
                          className="text-blue-600"
                          onClick={() =>
                            handleFeatureComingSoon("View All Services")
                          }
                        >
                          View All <ArrowRight className="h-4 w-4 ml-1" />
                        </Button>
                      ...
                      <div className="space-y-3">
                        {revenueByService.map((service, index) => (
                          <div
                            ...
                            onClick={() =>
                              navigateToBookings(`service: ${service.service}`)
                            }
                          >
                            <div className="flex items-center gap-3">
                              ...
                              <div className="flex-1">
                                <div className="flex items-center justify-between mb-1">
                                  ...
                                  <p className="text-lg font-bold text-purple-700">
                                    QAR {service.revenue.toLocaleString()}
                                  </p>
                                </div>
                                <div className="flex items-center gap-4 text-sm text-gray-600">
                    ...
                    <CardHeader>
                      <CardTitle className="flex items-center justify-between">
                        ...
                        <Button
                          ...
                          size="sm"
                          className="text-blue-600"
                          onClick={() => navigateToBookings("area view")}
                        >
                          View All <ArrowRight className="h-4 w-4 ml-1" />
                        </Button>
                      </CardTitle>
                      ...
                      <div className="space-y-3">
                        {revenueByArea.map((area, index) => (
                          <div
                            ...
                            className="p-4 bg-green-50 rounded-lg border border-green-200 cursor-pointer hover:shadow-md transition-all"
                            onClick={() =>
                              navigateToBookings(`area: ${area.area}`)
                            }
                          >
                            <div className="flex items-center gap-3">
                              ...
                              <div className="flex-1">
                                <div className="flex items-center justify-between mb-1">
                                  ...
                                  <p className="text-lg font-bold text-green-700">
                                    QAR {area.revenue.toLocaleString()}
                                  </p>
                                </div>
                        ...
                        <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                          ...
                          <div className="w-full bg-gray-200 rounded-full h-3 mb-2">
                            <div
                              ...
                              style={{
                                width: `${paymentStatus.collectionRate}%`,
                              }}
                            />
                          </div>
                          <p className="text-sm text-gray-600">
                            {paymentStatus.collectionRate}% of today's revenue
                            collected
                          </p>
                        </div>
                      </div>
