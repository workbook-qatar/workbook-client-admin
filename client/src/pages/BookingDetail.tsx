      ...
      <div className="max-w-[1600px] mx-auto p-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            <Badge
              className={`${getStatusColor(booking.status)} px-4 py-2 text-sm font-semibold border`}
            >
                  ...
                  <Button
                    ...
                    onClick={() =>
                      editingSection === "customer"
                        ? handleSave("Customer Information")
                        : handleEdit("customer")
                    }
          ...
          <div className="space-y-6">
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between text-base">
                    ...
                    <span className="font-semibold text-gray-900">
                      QR {(booking.price * 0.05).toFixed(2)}
                    </span>
                  </div>
                  <div className="border-t border-gray-200 pt-4 flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold text-gray-900">
                      QR {(booking.price * 1.05).toFixed(2)}
                    </span>
                  </div>
            ...
            <Card className="border border-gray-200 shadow-sm">
              <CardContent className="p-8">
                ...
                <div className="space-y-5">
                  {booking.history &&
                    booking.history.map((item: any, index: number) => (
