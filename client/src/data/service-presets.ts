    ...
    packages: [
      {
        id: "preset-pkg-1-1",
        code: "HHC-001",
        name: "4 Hour Cleaning — With Materials",
        duration: "4 hours",
        price: 200,
        materials: true,
      },
      {
        id: "preset-pkg-1-2",
        code: "HHC-002",
        name: "4 Hour Cleaning — Without Materials",
        duration: "4 hours",
        price: 160,
        materials: false,
      },
      {
        id: "preset-pkg-1-3",
        code: "HHC-003",
        name: "5 Hour Cleaning — With Materials",
        duration: "5 hours",
        price: 250,
        materials: true,
      },
      {
        id: "preset-pkg-1-4",
        code: "HHC-004",
        name: "5 Hour Cleaning — Without Materials",
        duration: "5 hours",
        price: 200,
        materials: false,
      },
      {
        id: "preset-pkg-1-5",
        code: "HHC-005",
        name: "6 Hour Cleaning — With Materials",
        duration: "6 hours",
        price: 300,
        materials: true,
      },
      {
        id: "preset-pkg-1-6",
        code: "HHC-006",
        name: "6 Hour Cleaning — Without Materials",
        duration: "6 hours",
        price: 240,
        materials: false,
      },
  ...
  },
  {
    ...
    packages: [
      ...
      },
      {
        id: "preset-pkg-2-2",
        code: "DC-002",
        name: "1 BR Apartment Deep Clean",
        duration: "5 hours",
        price: 550,
        materials: true,
      },
      {
        id: "preset-pkg-2-3",
        code: "DC-003",
        name: "Villa Deep Clean (Ground Floor)",
        duration: "8 hours",
        price: 1200,
        materials: true,
      },
